                    ...
                    <div class="main-bar">
                        ...
                        <div class="col-lg-6 col-sm-8 col-12">
                            <ol class="breadcrumb float-right  nav_breadcrumb_top_align">
                                ...
                                <li class="active breadcrumb-item">Shift Attendance View</li>
                            </ol>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="inner bg-container">
                        ...
                        <?php } ?>
                                ...
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <a href="<?=base_url('shift-attendance-register')?>" id="editable_table_new" class=" btn btn-default">
                                        Add Shift Attendance <i class="fa fa-plus"></i>
                                    </a>
                                    </div>
