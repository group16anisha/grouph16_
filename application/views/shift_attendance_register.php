                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 input_field_sections">
                                            <h5>Date <span style="color: #cc0000">*</span></h5>
											<input required type="text" class="form-control datepicker" name="aloDay" value=""/>
                                        </div>
                                    ...
                                    <div class="row">
										...
										<div class="col-lg-4 input_field_sections">
                                            <h5>Time In <span style="color: #cc0000">*</span></h5>
											<div class="input-group bootstrap-timepicker timepicker">
												<input required="" type="text" class="form-control input-small timepicker1" name="time_in">
												<span class="input-group-addon" style="cursor: pointer;"><i class="fa fa-clock-o"></i></span>
											</div>
										</div>
										
									    <div class="col-lg-4 input_field_sections">
                                            <h5>Time Out <span style="color: #cc0000">*</span></h5>
											<div class="input-group bootstrap-timepicker timepicker">
												<input required="" type="text" class="form-control input-small timepicker1" name="time_out">
												<span class="input-group-addon" style="cursor: pointer;"><i  class="fa fa-clock-o"></i></span>
											</div>
