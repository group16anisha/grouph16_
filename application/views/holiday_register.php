                ...
                <div class="main-bar">
                    ...
                    <div class="col-sm-7 col-lg-6">
                        <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                            ...
                            <li class="active breadcrumb-item">Holiday Register</li>
                        </ol>
                    </div>
                    </div>
                </div>
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row">
										<div class="col-lg-4 input_field_sections">
                                            <h5>Holiday Name <span style="color: #cc0000">*</span></h5>
											<input required type="text" class="form-control" name="holiday_name" value=""/>
                                        </div>
										
										<div class="col-lg-4 input_field_sections">
                                            <h5>Holiday Date <span style="color: #cc0000">*</span></h5>
											<input required  type="text" class="form-control datepicker" name="holiday_date" value=""/>
                                        </div>
                                    </div>
