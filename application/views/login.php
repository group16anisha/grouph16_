                ...
                <div class="col-lg-8 push-lg-2 col-md-10 push-md-1 col-sm-12">
                    <div class="login_logo login_border_radius1">
                        <h3 class="text-center">  
                            <span class="text-white"> Employee Shift Schedule<br/>
                                Log In</span>
                        </h3>
                    </div>
                        ...
                        <form id="login_validator" method="post" class="login_validator">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="<?=!empty($email)?$email:''?>" class="form-control  form-control-md" id="email" name="email" placeholder="E-mail">
                                </div>
                            </div>
                            <!--</h3>-->
                            <div class="form-group">
