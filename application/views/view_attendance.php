                    ...
                    <div class="main-bar">
                        ...
                        <div class="col-lg-6 col-sm-8 col-12">
                            <ol class="breadcrumb float-right  nav_breadcrumb_top_align">
                                ...
                                <li class="active breadcrumb-item">Attendance View</li>
                            </ol>
                        </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Attendance Date</th>
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">On Time</th>
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Off Time</th>
                                            ...
                                            <tbody>
                                                ...
                                                if(!empty($getAttendance))
                                                {
													...
													{ ?>
														<tr>
															<td style="display: none;"><?=$value->attId?></td>
															<td><?=$value->empFirstName?></td>
															<td><?=$value->attDate?></td>
															<td><?=$value->attonTime?></td>
															<td><?=$value->attoffTime?></td>
