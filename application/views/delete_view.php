                    ...
                    <div class="main-bar">
                        ...
                        <div class="col-lg-6 col-sm-8 col-12">
                            <ol class="breadcrumb float-right  nav_breadcrumb_top_align">
                                ...
                                <li class="active breadcrumb-item">Employee Delete</li>
                            </ol>
                        </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
													...
													<th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Delete</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                if(!empty($getEmployee))
                                                {
													...
													{ ?>
														<tr>
															...
															<td><a href="<?php echo base_url() . "Employee/rowDelete/" . $value->empID; ?>">Delete</a></td>
																												</tr>	
												<?php	}
                                                }
                                                ?>
