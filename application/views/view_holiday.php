                    ...
                    <div class="main-bar">
                        ...
                        <div class="col-lg-6 col-sm-8 col-12">
                            <ol class="breadcrumb float-right  nav_breadcrumb_top_align">
                                ...
                                <li class="active breadcrumb-item">Holiday View</li>
                            </ol>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="inner bg-container">
                        ...
                        <?php } ?>
                                ...
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <a href="<?=base_url('holiday-register')?>" id="editable_table_new" class=" btn btn-default">
                                        Add Holiday  <i class="fa fa-plus"></i>
                                    </a>
                                    </div>
                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Holiday Name</th>
                                                    <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Holiday Date</th>
                                            ...
                                            <tbody>
                                                ...
                                                if(!empty($getHoliday))
                                                {
													...
													{ ?>
														<tr>
															<td style="display: none;"><?=$value->holID?></td>
															<td><?=$value->holName?></td>
															<td><?=$value->holDate?></td>
															<td><?=$value->holDescription?></td>
